CREATE TABLE UnknownUgyfel
(LOGIN    nvarchar(20)   MASKED WITH (Function = 'default()') PRIMARY KEY ,
EMAIL         nvarchar(50)    MASKED WITH (Function = 'email()'),
NEV       nvarchar(50),
SZULEV   int   MASKED WITH (Function = 'random(1900,2024)'),
NEM    char            MASKED WITH (Function = 'default()'),
CIM    nvarchar(100)             MASKED WITH (Function = 'partial(2,"XXX",2)')
)
INSERT INTO UnknownUgyfel (LOGIN,EMAIL,NEV,SZULEV,NEM,CIM)
VALUES
...
CREATE USER Unknown_Data WITHOUT Login
GRANT SELECT ON UnknownUgyfel TO Unknown_Data

EXECUTE AS User = 'Unknown_Data'
SELECT * FROM UnknownUgyfel
REVERT